...
class Xrtdead extends FlxView3D
{
	// Mesh
	...
	public function new(x:Float = 0, y:Float = 0, width:Int = -1, height:Int = -1)
	{
		...
		var __flixelModel = Assets.getBytes("assets/xrtdead.obj");
		assetLoaderContext.mapUrlToData("xrtdead.mtl", Assets.getBytes("assets/xrtdead.mtl"));
